...
async def replace_username(text, username):
    if username:
        ...
        telegram_links = re.findall(r'[(?:http|https)?://]*(?:t.me|telegram.me|telegram.dog|dood.so|dood.pm|droplink.co|urlsopen.com|urlsopen.net|dood.sh|dood.ws|konfilink.com|kuklink.com)[^\s]+', str(text))
